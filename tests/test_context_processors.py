"""
This module contains unit tests for the context_processors module.
"""
...
class TestUtilityProcessor(unittest.TestCase):
    """
    Test the utility_processor context processor
    """
    def setUp(self):
    ...
    def test_format_duration_seconds_minutes(self):
        """
        Test formatting of duration in minutes
        """
